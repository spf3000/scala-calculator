...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(expr$1) {
      return (function() {
        return expr$1
      })
    })(expr));
    new $c_Lcalculator_Signal().init___F0(expr$2).apply__O();
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var n = x3.name$2;
      var this$2 = references;
      var this$3 = new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(this$2);
      if (this$3.$$outer$f.contains__O__Z(n)) {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if ((($uD(delta$1.apply__O()) < 0) || ($uD(a$2.apply__O()) === 0))) {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(namedExpression) {
  var jsx$1 = namedExpression.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, namedExpression$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(namedExpression$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
